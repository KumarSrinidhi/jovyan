...
class FlowAccumulator:
    ...
    def to_feature_dict(self) -> Dict[str, float]:
        ...
        features: Dict[str, float] = {
            "Flow Duration": _safe_float(duration_us),
            "Total Fwd Packets": float(fwd_pkts),
            "Total Backward Packets": float(bwd_pkts),
            "Total Length of Fwd Packets": _safe_float(fwd_bytes),
            "Total Length of Bwd Packets": _safe_float(bwd_bytes),
            "Fwd Packet Length Max": _safe_float(fwd_max),
            "Fwd Packet Length Min": _safe_float(fwd_min),
            "Fwd Packet Length Mean": _safe_float(fwd_mean),
            "Fwd Packet Length Std": _safe_float(fwd_std),
            "Bwd Packet Length Max": _safe_float(bwd_max),
            "Bwd Packet Length Min": _safe_float(bwd_min),
            "Bwd Packet Length Mean": _safe_float(bwd_mean),
            "Bwd Packet Length Std": _safe_float(bwd_std),
            "Flow Bytes/s": _safe_float(flow_bytes_s),
            "Flow Packets/s": _safe_float(flow_pkts_s),
            "Flow IAT Mean": _safe_float(flow_iat_mean),
            "Flow IAT Std": _safe_float(flow_iat_std),
            "Flow IAT Max": _safe_float(flow_iat_max),
            "Flow IAT Min": _safe_float(flow_iat_min),
            "Fwd IAT Total": _safe_float(fwd_iat_total),
            "Fwd IAT Mean": _safe_float(fwd_iat_mean),
            "Fwd IAT Std": _safe_float(fwd_iat_std),
            "Fwd IAT Max": _safe_float(fwd_iat_max),
            "Fwd IAT Min": _safe_float(fwd_iat_min),
            "Bwd IAT Total": _safe_float(bwd_iat_total),
            "Bwd IAT Mean": _safe_float(bwd_iat_mean),
            "Bwd IAT Std": _safe_float(bwd_iat_std),
            "Bwd IAT Max": _safe_float(bwd_iat_max),
            "Bwd IAT Min": _safe_float(bwd_iat_min),
            "Fwd PSH Flags": float(self.fwd_psh_count),
            "Bwd PSH Flags": float(self.bwd_psh_count),
            "Fwd URG Flags": float(self.fwd_urg_count),
            "Bwd URG Flags": float(self.bwd_urg_count),
            "Fwd Header Length": _safe_float(fwd_header_len),
            "Bwd Header Length": _safe_float(bwd_header_len),
            "Fwd Packets/s": _safe_float(fwd_pkts_s),
            "Bwd Packets/s": _safe_float(bwd_pkts_s),
            "Min Packet Length": _safe_float(pkt_min),
            "Max Packet Length": _safe_float(pkt_max),
            "Packet Length Mean": _safe_float(pkt_mean),
            "Packet Length Std": _safe_float(pkt_std),
            "Packet Length Variance": _safe_float(pkt_variance),
            ...
            "Down/Up Ratio": _safe_float(down_up_ratio),
            "Average Packet Size": _safe_float(avg_pkt_size),
            "Avg Fwd Segment Size": _safe_float(avg_fwd_seg_size),
            "Avg Bwd Segment Size": _safe_float(avg_bwd_seg_size),
            "Fwd Header Length.1": _safe_float(fwd_header_len),
            "Fwd Avg Bytes/Bulk": _safe_float(fwd_bulk_avg_bytes),
            "Fwd Avg Packets/Bulk": _safe_float(fwd_bulk_avg_pkts),
            "Fwd Avg Bulk Rate": _safe_float(fwd_bulk_avg_rate),
            "Bwd Avg Bytes/Bulk": _safe_float(bwd_bulk_avg_bytes),
            "Bwd Avg Packets/Bulk": _safe_float(bwd_bulk_avg_pkts),
            "Bwd Avg Bulk Rate": _safe_float(bwd_bulk_avg_rate),
            "Subflow Fwd Packets": float(fwd_pkts),
            "Subflow Fwd Bytes": _safe_float(fwd_bytes),
            "Subflow Bwd Packets": float(bwd_pkts),
            "Subflow Bwd Bytes": _safe_float(bwd_bytes),
            "Init_Win_bytes_forward": float(self.first_fwd_window or 0),
            "Init_Win_bytes_backward": float(self.first_bwd_window or 0),
            "act_data_pkt_fwd": float(self.act_data_pkt_fwd),
            "min_seg_size_forward": _safe_float(min_seg_size_forward),
            "Active Mean": _safe_float(active_mean),
            "Active Std": _safe_float(active_std),
            "Active Max": _safe_float(active_max),
            "Active Min": _safe_float(active_min),
            "Idle Mean": _safe_float(idle_mean),
            "Idle Std": _safe_float(idle_std),
            "Idle Max": _safe_float(idle_max),
            "Idle Min": _safe_float(idle_min),
        }
...
class FlowBuilder:
    ...
    def _export_key(self, key: FlowKey) -> Dict[str, object]:
        ...
        duration_seconds = features["Flow Duration"] / 1e6
